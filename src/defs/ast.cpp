...
void VariableDeclarationStatement::accept(ASTVisitor &visitor) { visitor.visit(*this); }
void ExpressionStatement::accept(ASTVisitor &visitor) { visitor.visit(*this); }
void UnaryMutationStatement::accept(ASTVisitor &visitor) { visitor.visit(*this); }
...
void CharLiteralExpr::accept(struct ASTVisitor &visitor) { visitor.visit(*this); }
...
void ParenthesisExpression::accept(struct ASTVisitor &visitor) { visitor.visit(*this); }
void BinaryOperatorExpression::accept(struct ASTVisitor &visitor) { visitor.visit(*this); }
void UnaryOperatorExpression::accept(struct ASTVisitor &visitor) { visitor.visit(*this); }
...
void ArrayAccessExpr::accept(struct ASTVisitor &visitor) { visitor.visit(*this); }
...
void VariableLValue::accept(struct ASTVisitor &visitor) { visitor.visit(*this); }
void DereferenceLValue::accept(struct ASTVisitor &visitor) { visitor.visit(*this); }
void ArrayAccessLValue::accept(struct ASTVisitor &visitor) { visitor.visit(*this); }
void FieldAccessLValue::accept(struct ASTVisitor &visitor) { visitor.visit(*this); }
void PointerAccessLValue::accept(struct ASTVisitor &visitor) { visitor.visit(*this); }
