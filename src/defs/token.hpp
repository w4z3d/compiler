...
const std::unordered_set<token::TokenKind> binary_ops = {
    ...
    token::TokenKind::Asterisk,      token::TokenKind::Slash,
    token::TokenKind::Percent,       token::TokenKind::LAngleAngle,
    token::TokenKind::RAngleAngle,   token::TokenKind::LAngleBracket,
    token::TokenKind::RAngleBracket, token::TokenKind::LessEqual,
    token::TokenKind::GreaterEqual,  token::TokenKind::EqualEqual,
    token::TokenKind::BangEqual,     token::TokenKind::And,
    token::TokenKind::PipePipe,      token::TokenKind::AndAnd,
    token::TokenKind::Pipe,          token::TokenKind::Caret};

const std::unordered_set<token::TokenKind> unary_ops = {
    token::TokenKind::Bang, token::TokenKind::Minus, token::TokenKind::Tilde,
    token::TokenKind::Asterisk};

const std::unordered_set<token::TokenKind> assignment_ops = {
    token::TokenKind::PlusEquals,        token::TokenKind::MinusEquals,
    token::TokenKind::AsteriskEquals,    token::TokenKind::SlashEquals,
    token::TokenKind::PercentEquals,     token::TokenKind::LAngleAngleEquals,
    token::TokenKind::RAngleAngleEquals, token::TokenKind::AndEquals,
    token::TokenKind::CaretEquals,       token::TokenKind::Equals,
    token::TokenKind::PipeEquals,
};

const std::unordered_set<token::TokenKind> post_ops = {
    token::TokenKind::PlusPlus, token::TokenKind::MinusMinus};
